...
static const PsxrecompCodegenHostConfig kCodegenConfig = {
    .display_name = "Legend of Mana",
    .project_root_env = "LEGEND_OF_MANA_RECOMP_PROJECT_ROOT",
    .build_dir_env = "LEGEND_OF_MANA_RECOMP_BUILD_DIR",
    .force_setup_env = "LEGEND_OF_MANA_RECOMP_FORCE_SETUP",
    .psxrecomp_cli_relpath = "psxrecomp/psxrecomp_cli.py",
    .seed_cfg_relpath = "game.toml",
    .game_toml_relpath = "game.toml",
    .gen_marker_relpath = "generated/SLUS_010.13_dispatch.c",
    .build_dir_name = "build-release",
    .cmake_target = "psx-runtime",
    .exe_basename = "Legend_of_Mana__Recompiled",
    .prepare_note =
